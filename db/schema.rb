...
ActiveRecord::Schema[7.2].define(version: 2025_08_09_095341) do
  ...
  create_table "trades", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "currency"
    t.jsonb "locked_attributes", default: {}
    t.boolean "deposit_less", default: false, null: false
    t.index ["deposit_less"], name: "index_trades_on_deposit_less"
